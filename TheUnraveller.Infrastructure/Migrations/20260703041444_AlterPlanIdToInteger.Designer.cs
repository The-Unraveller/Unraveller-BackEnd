...
namespace TheUnraveller.Infrastructure.Migrations
{
    ...
    [Migration("20260703041444_AlterPlanIdToInteger")]
    partial class AlterPlanIdToInteger
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheUnraveller.Core.Entities.MissionSubTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.PrimitiveCollection<List<string>>("TriggerKeywords")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.HasIndex("MissionId", "OrderIndex")
                        .IsUnique();

                    b.ToTable("MissionSubTasks", (string)null);
                });
            ...
            modelBuilder.Entity("TheUnraveller.Core.Entities.UserSubTaskProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("UserId", "SubTaskId")
                        .IsUnique();

                    b.ToTable("UserSubTaskProgress", (string)null);
                });
            ...
            modelBuilder.Entity("TheUnraveller.Core.Entities.UserSubTaskProgress", b =>
                {
                    ...
                    b.HasOne("TheUnraveller.Core.Entities.MissionSubTask", "SubTask")
                        .WithMany()
            ...
            modelBuilder.Entity("TheUnraveller.Core.Entities.UserSubscription", b =>
                {
                    b.HasOne("TheUnraveller.Core.Entities.SubscriptionPlan", "Plan")
                        .WithMany()
