...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Mission>().HasData(
            new Mission { Id = 1, Title = "Coffee Shop Conversations", Goal = "Practice ordering, small talk, and social English in a café setting.", Description = "*The hum of neon lights fills the cozy cyber-café. The Barista wipes down the metallic counter, looking up with a friendly smile.* \"Welcome to Neon Mug! What can I get started for you today? We've got fresh cyber-brews and synthetic pastries.\"", StartSuspicion = 10, MaxSuspicion = 100, Stage = "Stage 1", Difficulty = "Beginner", XpReward = 150, ImageUrl = "/scenario_coffee.png", Locked = false, NpcId = 1, GrammarTarget = "Sử dụng câu nói lịch sự với 'Would like' hoặc động từ khuyết thiếu 'Could/May'." },
            new Mission { Id = 2, Title = "Following Instructions", Goal = "Listen carefully, understand tasks, and execute with precision.", Description = "*The Supervisor taps their digital clipboard impatiently as you step into the assembly bay. The neon screens flicker behind them.* \"You're late. We have a heavy shipment of hover-car battery cores to calibrate today. Let me know when you're ready for your instructions.\"", StartSuspicion = 10, MaxSuspicion = 100, Stage = "Stage 2", Difficulty = "Beginner", XpReward = 200, ImageUrl = "/scenario_classroom.png", Locked = false, NpcId = 2, GrammarTarget = "Sử dụng câu mệnh lệnh (Imperatives) hoặc thể bị động (Passive voice) để xác nhận nhiệm vụ." },
            new Mission { Id = 3, Title = "Debate & Negotiation", Goal = "Practice arguing your point and reaching agreements in English.", Description = "*The glass walls of the boardroom overlook the sprawling city skyline. The CEO leans forward, folding their hands.* \"Thank you for coming. We need to reach a deal on the technology sharing agreement. If you agree to our terms, we can sign today. What are your thoughts?\"", StartSuspicion = 10, MaxSuspicion = 100, Stage = "Stage 3", Difficulty = "Intermediate", XpReward = 300, ImageUrl = "", Locked = true, NpcId = 2, GrammarTarget = "Sử dụng câu điều kiện loại 1 (If... will...) hoặc loại 2 (If... would...) để đàm phán." },
            new Mission { Id = 4, Title = "Job Interview", Goal = "Ace an English job interview with proper vocabulary and confidence.", Description = "*You sit opposite the interviewer in a sleek high-tech office. The HR manager smiles warmly.* \"Welcome. I've reviewed your credentials and they look impressive. To begin, could you tell me why you want to work here at CyberTech Industries?\"", StartSuspicion = 10, MaxSuspicion = 100, Stage = "Stage 4", Difficulty = "Intermediate", XpReward = 350, ImageUrl = "", Locked = true, NpcId = 2, GrammarTarget = "Sử dụng câu phức chứa mệnh đề quan hệ (Relative Clauses) hoặc liên từ (Because, Although)." },
            new Mission { Id = 5, Title = "Detective Writing", Goal = "Describe scenes and solve mysteries in written English.", Description = "*Rain beats against the dirty precinct window. Chief Detective Henderson tosses a case file containing glowing holograms onto the table.* \"Grab a seat. The cyber-vault at Sector 7 was cracked wide open last night. Tell me exactly what you found at the crime scene.\"", StartSuspicion = 10, MaxSuspicion = 100, Stage = "Stage 5", Difficulty = "Advanced", XpReward = 500, ImageUrl = "/scenario_detective.png", Locked = false, NpcId = 3, GrammarTarget = "Sử dụng trạng từ mô tả (Descriptive Adverbs) và thì Quá khứ đơn (Past Simple) để báo cáo chứng cứ." },
            new Mission { Id = 6, Title = "Advanced Roleplay", Goal = "Complex multi-character scenarios with layered objectives.", Description = "*You stand in the dim undercity market, surrounded by holographic advertisements. A shady merchant whispers from the shadows.* \"Psst... I hear you're looking for the decryption key. I might have it, but it's going to cost you. What did you bring to trade?\"", StartSuspicion = 10, MaxSuspicion = 100, Stage = "Stage 6", Difficulty = "Advanced", XpReward = 600, ImageUrl = "", Locked = true, NpcId = 3, GrammarTarget = "Sử dụng câu giả định (Subjunctive Mood) hoặc lối nói gián tiếp (Reported Speech) ở trình độ cao." }
        );
