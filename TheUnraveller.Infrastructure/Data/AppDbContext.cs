...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Mission>().HasData(
            ...
            new Mission { Id = 2, Title = "Following Instructions", Goal = "Listen carefully, understand tasks, and execute with precision.", Description = "You've been assigned several tasks today. Listen carefully to each instruction and complete everything with minimal mistakes.", StartSuspicion = 10, MaxSuspicion = 100, Stage = "Stage 2", Difficulty = "Beginner", XpReward = 200, ImageUrl = "/scenario_classroom.png", Locked = false, NpcId = 2, GrammarTarget = "Sử dụng câu mệnh lệnh (Imperatives) hoặc thể bị động (Passive voice) để xác nhận nhiệm vụ." },
            ...
            new Mission { Id = 5, Title = "Detective Writing", Goal = "Describe scenes and solve mysteries in written English.", Description = "A crime has been committed. As the lead detective, you must gather evidence, interview suspects, and file your report.", StartSuspicion = 10, MaxSuspicion = 100, Stage = "Stage 5", Difficulty = "Advanced", XpReward = 500, ImageUrl = "/scenario_detective.png", Locked = false, NpcId = 3, GrammarTarget = "Sử dụng trạng từ mô tả (Descriptive Adverbs) và thì Quá khứ đơn (Past Simple) để báo cáo chứng cứ." },
            new Mission { Id = 6, Title = "Advanced Roleplay", Goal = "Complex multi-character scenarios with layered objectives.", Description = "Complex multi-character scenarios with layered objectives to test fluency.", StartSuspicion = 10, MaxSuspicion = 100, Stage = "Stage 6", Difficulty = "Advanced", XpReward = 600, ImageUrl = "", Locked = true, NpcId = 3, GrammarTarget = "Sử dụng câu giả định (Subjunctive Mood) hoặc lối nói gián tiếp (Reported Speech) ở trình độ cao." }
        );
